...
const Banner = () => {
  return (
    <div className="header-bg  " style={{ backgroundImage: `url(${bg})` }} >
      ...
      <h1 className=" font-bold  lg:text-5xl text-3xl text-white lg:max-w-2xl lg:pt-28 pl-6 pt-10 ">
        Dewdrops Offers For
      </h1>
      <h1 className=" font-bold  lg:text-5xl text-3xl text-white max-w-lg lg:py-8 py-1 pl-6 ">
        Cold Winter!
      </h1>
